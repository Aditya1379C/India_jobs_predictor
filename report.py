...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .title {{ font-family: 'Syne', sans-serif; font-size: clamp(28px,4vw,46px); font-weight: 800; line-height: 1.05; }}
    ...
    .nav-btn {{ display: flex; align-items: center; gap: 7px; background: var(--card); border: 1px solid var(--border); border-radius: 8px; padding: 8px 16px; font-family: 'DM Mono', monospace; font-size: 13px; color: var(--text2); cursor: pointer; transition: all 0.2s; letter-spacing: 0.5px; }}
    ...
    .kpi-val {{ font-family: 'Syne', sans-serif; font-size: 30px; font-weight: 800; color: var(--kpi-color, var(--accent)); line-height: 1; margin-bottom: 5px; }}
    ...
    .card-title {{ font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 700; color: var(--text); text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 4px; }}
    ...
    .filter-select {{
      ...
      padding: 7px 12px; font-family: 'DM Mono', monospace; font-size: 13px; color: var(--text);
      cursor: pointer; outline: none; transition: border-color 0.2s;
    }}
    .filter-select:focus {{ border-color: var(--accent); }}
    .filter-reset {{ background: none; border: 1px solid var(--border); border-radius: 8px; padding: 7px 12px; font-family: 'DM Mono', monospace; font-size: 13px; color: var(--text2); cursor: pointer; transition: all 0.2s; }}
    ...
    .section-heading-num {{ font-family: 'Syne', sans-serif; font-size: 12px; font-weight: 700; color: var(--accent); background: color-mix(in srgb,var(--accent) 10%,transparent); border: 1px solid color-mix(in srgb,var(--accent) 25%,transparent); border-radius: 6px; padding: 4px 10px; letter-spacing: 2px; }}
    .section-heading-title {{ font-family: 'Syne', sans-serif; font-size: 20px; font-weight: 700; }}
    ...
    .salary-val {{ width: 56px; text-align: right; color: var(--text); font-size: 13px; flex-shrink: 0; font-family: 'Syne', sans-serif; font-weight: 600; }}
    ...
    .pred-select, .pred-input {{
      ...
      padding: 10px 14px; font-family: 'DM Mono', monospace; font-size: 14px; color: var(--text);
      outline: none; transition: border-color 0.2s;
    }}
    .pred-select:focus, .pred-input:focus {{ border-color: var(--accent); }}
    .pred-exp-row {{ display: flex; align-items: center; gap: 12px; }}
    .pred-exp-val {{ font-family: 'Syne', sans-serif; font-weight: 700; font-size: 18px; color: var(--accent); min-width: 36px; }}
    ...
    .pred-btn {{
      ...
      padding: 13px 24px; font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 700;
    ...
    .pred-result-val {{ font-family: 'Syne', sans-serif; font-size: 48px; font-weight: 800; color: var(--accent3); line-height: 1; }}
    ...
    .pred-breakdown-row span:last-child {{ color: var(--text); font-family: 'Syne', sans-serif; font-weight: 600; }}
    ...
    .theme-toggle {{
      ...
      color: var(--text2); cursor: pointer; transition: all 0.2s; letter-spacing: 0.5px;
    ...
    .run-btn {{
      ...
      background: var(--card); border: 1px solid var(--border); border-radius: 8px;
      padding: 9px 16px; font-family: 'DM Mono', monospace; font-size: 13px;
      color: var(--text2); cursor: pointer; transition: all 0.2s; letter-spacing: 0.5px;
    }}
    ...
    <div class="predictor-grid">
      ...
      <div class="card">
        ...
        <div class="pred-form">
          ...
          <div class="pred-field">
            <label>Years of Experience &nbsp; <span id="exp-display" style="color:var(--accent);font-family:'Syne',sans-serif;font-weight:700">0</span> yrs</label>
...
const FONT = {{ family: 'DM Mono', size: 12 }};
const AXIS_TITLE_FONT = {{ family: 'DM Mono', size: 13 }};
let TIP  = _initDark
